...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
                    ...
                    <div class="col-md-12">
                        <div class="top-section">
                            <div class="profile-image">
                                <img src="image/profile.jpg" alt="Volton">
                            </div>
        ...
        <div class="sidebar-menu hidden-xs hidden-sm">
            <div class="top-section">
                <div class="profile-image">
                    <img src="image/profile.jpg" alt="官先森">
                </div>
                <h3 class="profile-title">官先森</h3>
                <p class="profile-description">攻城狮</p>
            </div> <!-- top-section -->
            <div class="main-navigation">
                <ul class="navigation">
                    <li><a href="#top"><i class="fa fa-globe"></i>Welcome</a></li>
                    <li><a href="#about"><i class="fa fa-pencil"></i>About Me</a></li>
                    <li><a href="#projects"><i class="fa fa-paperclip"></i>My Blog</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="about-image">
                                <img src="image/8.jpg" alt="about me">
                            </div>
